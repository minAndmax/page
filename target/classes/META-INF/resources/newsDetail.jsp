...
<!-- header -->
	<div class="container">
		<div class="header">
			<div class="logo">
				<div style="height: 60px;font-style: italic;font-size: 15px;" id="showdate"></div>
			</div>
		...
		<div class="footer">
			...
			<div class="footer-bottom">
				<div class="foot-left">
					...
					<ul>
					    <li class="active"><a href="index.html">首页</a></li>
					  <li><a href="blog.html" target="_blank">头条新闻</a></li>
						<li><a href="pullNewsList.html" target="_blank">天下杂谈</a></li>
							<div class="clearfix"></div>
					</ul>
					</div>					
				</div>
